...
public class JImagePanel extends JPanel implements MouseListener, MouseMotionListener, MouseWheelListener {
     ...
     */
    public JImagePanel(JScrollPane scrollPane, Window parentComponent) throws Exception {
        if (scrollPane == null)
     ...
     */
    public JImagePanel(JScrollPane scrollPane, Window parentComponent, BufferedImage newIm) throws Exception {
